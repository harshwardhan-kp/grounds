...
const CLUSTERS: ClaimCluster[] = [
  {
    ...
    enginesObserved: ["google_ai_mode"],
    frequency: 0.6,
    sampleCount: 10,
    inconsistent: false,
    memberClaimIds: ["clm_02"],
  },
  {
    id: "cls_contradicted_founding",
    auditId: AUDIT_ID,
    canonicalText: "Wolf River Electric was established in 2008 as a rural electrical contractor.",
    verdict: "CONTRADICTED",
    polarity: "neutral",
    ...
    sampleCount: 10,
    inconsistent: true,
    memberClaimIds: ["clm_03"],
  },
  {
    id: "cls_stale_warranty",
    auditId: AUDIT_ID,
    ...
    sampleCount: 10,
    inconsistent: false,
    memberClaimIds: ["clm_05"],
  },
  {
    id: "cls_unverifiable_coverage",
    auditId: AUDIT_ID,
    canonicalText: "Wolf River Electric offers service coverage across eastern Minnesota and western Wisconsin.",
    verdict: "UNVERIFIABLE",
    polarity: "neutral",
